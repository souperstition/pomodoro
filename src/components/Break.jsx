...
const Break = ({ breakLength, handleBreakDecrement, handleBreakIncrement, isRunning }) => {
	return (
		<div className="w-1/2 flex justify-center items-center gap-x-2" role="group">
			<button disabled={isRunning} onClick={handleBreakDecrement} id="break-decrement">
			...
			<button disabled={isRunning} onClick={handleBreakIncrement} id="break-increment">
